...
systemctl disable apport.service logrotate.service snapd.seeded.service grub-common.service keyboard-setup.service systemd-update-utmp.service systemd-fsck-root.service systemd-tmpfiles-setup.service plymouth-quit.service plymouth-quit-wait.service systemd-journal-flush.service apparmor.service systemd-fsck-root.service e2scrub_reap.service
