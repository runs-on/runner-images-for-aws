...
// Ubuntu 26 arm64 builds on a disposable, enlarged source root and publishes
// only a fresh compact target. bin/build selects this source exclusively when
// compact_root is enabled; Ubuntu 22 and 24 retain amazon-ebs.build_ebs.
