...
* Fresh Ubuntu 26 x64 UEFI launches use a one-shot direct kernel boot without console output. GRUB stays first for reboots, recovery, and serial diagnostics. Ubuntu 26 arm64 stays on GRUB. Secure Boot is outside this fast-path contract and falls back through shim and GRUB.
